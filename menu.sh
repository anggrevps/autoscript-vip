...
mkdir /etc/github
echo "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" > /etc/github/api
echo "ketanngoreng@gmail.com" > /etc/github/email
